...
This vignette provides hands-on examples for analyzing job
specialization, title mapping, and promotion networks using the
**cmapr** package and the [CMap Career Mobility
Dataset](https://www.nature.com/articles/s41597-025-05526-3).

The examples are designed to help you efficiently explore and visualize
the data, leveraging tidyverse tools for clarity and reproducibility.

------------------------------------------------------------------------

### **1. Loading and Inspecting Specialization Data**

The specialization index (SI) quantifies how distinctive a job title is
within its sector.
...
The title mapping data helps you understand how raw job titles are
...
Promotion networks show observed transitions between job titles, both
validated (manually reviewed) and unvalidated (algorithmic).
...
You can visualize promotion networks interactively (if HTML files are
available):
...
- Combine `cmapr` data tables with external labor market data for
  advanced modeling.

- Use the specialization index to identify emerging or declining roles.

- Explore cross-sector mobility patterns to inform workforce
  development.

**References:**

- [CMap Career Mobility Dataset - Nature Scientific Data
